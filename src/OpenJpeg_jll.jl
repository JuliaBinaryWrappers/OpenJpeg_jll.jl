...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OpenJpeg_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("643b3616-a352-519d-856d-80112ee9badc"))
platforms = [Pkg.Artifacts.unpack_platform(e, "OpenJpeg", artifacts_toml) for e in artifacts["OpenJpeg"]]
...
if best_platform === nothing
    @debug("Unable to load OpenJpeg; unsupported platform $(triplet(platform_key_abi()))")
else
