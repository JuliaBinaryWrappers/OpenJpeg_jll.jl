...
const opj_decompress_splitpath = ["bin", "opj_decompress.exe"]
...
const libopenjp2_splitpath = ["bin", "libopenjp2.dll"]
...
const libopenjp2 = "libopenjp2.dll"


# Relative path to `opj_compress`
const opj_compress_splitpath = ["bin", "opj_compress.exe"]
...
const opj_dump_splitpath = ["bin", "opj_dump.exe"]
